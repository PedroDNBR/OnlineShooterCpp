...
#include "OnlineShooterCpp/HUD/CharacterOverlay.h"
...
#include "OnlineShooterCpp/HUD/Announcement.h"
#include "OnlineShooterCpp/Types/Announcement.h"
...
#include "OnlineShooterCpp/HUD/ReturnToMainMenu.h"
...
void ABlasterPlayerController::PollInit()
{
	if (CharacterOverlay == nullptr)
	{
		if (BlasterHUD && BlasterHUD->CharacterOverlay)
		{
			...
			if (CharacterOverlay)
			{
				if (bInitializeHeath) SetHUDHealth(HUDHealth, HUDMaxHealth);
...
FString ABlasterPlayerController::GetInfoText(const TArray<class ABlasterPlayerState*>& Players)
{
	...
	if (Players.Num() == 0)
	{
		InfoTextString = Announcement::ThereIsNowWinner;
	}
